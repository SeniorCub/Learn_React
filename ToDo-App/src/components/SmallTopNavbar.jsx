...
const SmallTopNavbar = () => {
     return (
     <>
          <nav className="fixed top-0 flex justify-between w-[100vw] md:hidden bg-color3 p-1 items-center h-[10vh]">
               ...
               <label className="input input-bordered flex items-center gap-2 bg-color1">
               <input type="text" className="grow placeholder:text-gray-300" placeholder="Search" />
               </label>
               </div>
