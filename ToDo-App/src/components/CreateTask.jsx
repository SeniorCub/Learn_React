...
const CreateTask = ({ allTasks, setAllTasks, setCompletedTasks }) => {
  ...
  return (
    <>
          <button  className="bg-color3 w-16 h-16 flex flex-col justify-center items-center rounded-full -translate-y-5 fixed right-1/2 md:right-16 bottom-4 transform translate-x-1/2"  onClick={() => setIsOpened(!isOpen)}>
